<div class="modal fade" id="alternatifCreateModal" tabindex="-1" aria-labelledby="alternatifCreateModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('pengguna_utama.alternatif.store') }}">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="namaAlternatif" class="form-label">Nama
                            {{ $kategori ? $kategori->nama : '' }}</label>
                        <input type="text" name="nama" id="namaAlternatif" class="form-control"
