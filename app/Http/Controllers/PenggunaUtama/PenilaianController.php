...
class PenilaianController extends Controller
{
    public function index($kategoriPenilaianId)
    {
        try {
            ...
            return view('Pengguna Utama.Penilaian.Penilaian', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('pengguna_utama.penilaian.index', ['kategoriPenilaianId' => $penilaianData[0]['id_kategori_penilaian']])
    ...
    public function show($id)
    {
        try {
            ...
            // Ambil Kriteria terkait dengan kategori kriteria alternatif
