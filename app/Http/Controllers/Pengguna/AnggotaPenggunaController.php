...
class AnggotaPenggunaController extends Controller
{
    ...
    public function index()
    {
        ...
        $anggota = Anggota::where('users_id', $userId)
            ->where('id', '!=', $loggedInUserId)
            ->get();
        return view('Pengguna.Anggota.Anggota', compact('anggota'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengguna.anggota.index')->with('success', 'Anggota berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Pengguna.Anggota.Anggota_update', compact('anggota'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pengguna.anggota.index')->with('success', 'Data anggota berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pengguna.anggota.index')->with('success', 'Anggota berhasil dihapus');
    }
}